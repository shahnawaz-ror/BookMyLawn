...
class GalleriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post galleries_url, params: { gallery: { active: @gallery.active, description: @gallery.description, image: @gallery.image } }
    end
  ...
  test "should update gallery" do
    patch gallery_url(@gallery), params: { gallery: { active: @gallery.active, description: @gallery.description, image: @gallery.image } }
